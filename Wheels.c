...
//    SysCtlPWMClockSet(SYSCTL_PWMDIV_8); //Set PWM clock to 2MHz
    ...
    GPIOPadConfigSet(GPIO_PORTB_BASE, GPIO_PIN_4 | GPIO_PIN_5, GPIO_STRENGTH_4MA, GPIO_PIN_TYPE_OD);
...
int Wheels(int wheels_spd_left, int wheels_spd_right, int wheels_dir_left, int wheels_dir_right)
{
    if (wheelsRun == 1){
